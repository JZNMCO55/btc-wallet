...
const $viewPresets = {
  ...
  feature: Object.assign({}, $baseViewStyle, {
...
const $textPresets: Record<Presets, CSSProperties> = {
  ...
  feature: Object.assign({}, $baseTextStyle, { color: colors.white }),
    ...
    return (
      <div
        ...
        <Column style={{ alignItems: 'center' }}>
          <div style={featureIcon}>{icon && <Icon icon={icon} style={{ backgroundColor: $textStyle.color }} />}</div>
          {text && <Text text={text} style={$textStyle} />}
