...
function PasswordInput(props: InputProps) {
  ...
  const [showPassword, setShowPassword] = useState(false); // 新增的状态，控制密码是否显示
  const inputStyles = {
    backgroundColor: 'rgb(52, 52, 52)',
    border: isFocused ? '1px solid rgb(3, 118, 201)' : '1px solid rgb(255, 255, 255, 1)',
  ...
  return (
    <div
      ...
      style={Object.assign({}, $baseContainerStyle, containerStyle, inputStyles)}>
      <input
